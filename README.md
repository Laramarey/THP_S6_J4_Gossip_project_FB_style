...
- aller dans le patch du dossier, bien penser à ouvrir le gemfile et mettre un #devant la gem tzinfo..., bundle install, ensuite rails db:setup, rails s

- ou plus long - bundle install - rails db:create |rails db:migrate | rails db:seed - rails s

=> aller à  http://localhost:3000 and enjoy ;)
 templates bootstrap
